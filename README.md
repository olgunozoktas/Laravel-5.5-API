...
This is a tutorial to create API in PHP/Laravel Framework which is followed on youtube. [Video][1]
...
~~~~~~~~
    ...
    public function index()
    {
        ...
        //If u want to return a list then you have to write ::collection methods
    }
    ...
    {   
        //Check the method type - put or post
